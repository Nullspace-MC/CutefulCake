package net.nullspace_mc.cutefulcake.logging;

import net.nullspace_mc.cutefulcake.counter.Counter;
import net.nullspace_mc.cutefulcake.counter.CounterRegistry;
import net.nullspace_mc.cutefulcake.mixin.core.PlayerListHeaderS2CPacketMixin;
import net.nullspace_mc.cutefulcake.settings.CutefulCakeSettings;
import net.nullspace_mc.cutefulcake.util.MathUtil;
